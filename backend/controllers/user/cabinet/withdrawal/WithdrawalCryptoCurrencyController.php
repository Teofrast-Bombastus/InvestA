...
use backend\forms\user\WithdrawalCryptoCurrencySearch;
...
class WithdrawalCryptoCurrencyController extends Controller
{
    ...
    {
        $searchModel = new WithdrawalCryptoCurrencySearch();
    ...
    {
        try{
            $this->userManegeService->successWithdrawalCryptoCurrency($id);
    ...
    {
        try{
            $this->userManegeService->rejectWithdrawalCryptoCurrency($id);
    ...
    {
        if (($model = WithdrawalCryptoCurrency::findOne($id)) !== null) {
            return $model;
        }
