...
use backend\forms\user\WithdrawalDebitCreditCardSearch;
...
class WithdrawalDebitCreditCardController extends Controller
{
    ...
    {
        $searchModel = new WithdrawalDebitCreditCardSearch();
    ...
    {
        try{
            $this->userManegeService->successWithdrawalDebitCreditCard($id);
    ...
    {
        try{
            $this->userManegeService->rejectWithdrawalDebitCreditCard($id);
    ...
    {
        if (($model = WithdrawalDebitCreditCard::findOne($id)) !== null) {
            return $model;
        }
