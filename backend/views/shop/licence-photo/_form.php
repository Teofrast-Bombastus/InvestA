...
/* @var $licencePhoto shop\entities\shop\LicencePhoto|null */
...
<div class="article">
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3>Фото</h3>
            <h5 class="text-muted">Рекомендованый размер: ширина - <?= Yii::$app->params['licencePhotoWidth'] ?>px; высота - <?= Yii::$app->params['licencePhotoHeight'] ?>x; </h5>
        </div>
        <div class="box-body">
            <div class="row">
                <?php if (isset($licencePhoto)): ?>
                    <?php if ($licencePhoto->image): ?>
                        <div class="col-md-2 col-xs-3" style="text-align: center">
                            <div class="btn-group">
                                <?= Html::a('<span class="glyphicon glyphicon-remove"></span>', ['delete-photo', 'id' => $licencePhoto->id], [
