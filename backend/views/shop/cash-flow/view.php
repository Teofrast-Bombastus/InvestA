...
/* @var $galleryFilesForm shop\forms\manage\shop\cashFlow\GalleryFileForm */
/* @var $dataProvider yii\data\ActiveDataProvider */


$this->title = 'Ввод-вывод средств (получения дивидендов)';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="user-view">

    <p>
        <?= Html::a('Изменить', ['update', 'id' => $cashFlow->id], ['class' => 'btn btn-primary']) ?>
    </p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'header' => 'Действия',
                                'template' => '{delete}',
                                'urlCreator' => function ($action, $model, $key, $index) use ($cashFlow) {
                                    if ($action === 'delete') {
                                        $url = Url::to(['delete-file', 'id' => $cashFlow->id, 'file_id' => $model->id]);
                                        return $url;
                                    }
