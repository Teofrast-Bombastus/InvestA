...
/* @var  $model shop\forms\user\cabinet\withdrawal\WithdrawalDebitCreditCardForm */
...
<h2>На дебетовую или кредитную карту > Вывод средств</h2>
    ...
    <div class="open-depo-min-wrapper-form">
        <div class="profile-info-page-form-block">
            ...
            <div class="profile-info-page-form-block">
                ...
                <?= $form->field($model, 'card_number')->textInput(["class" => "input", "placeholder" => $model->getAttributeLabel('card_number')])->label(false) ?>

                <?= $form->field($model, 'card_holder')->textInput(["class" => "input", "placeholder" => $model->getAttributeLabel('card_holder')])->label(false) ?>

                <?= $form->field($model, 'expire')->textInput(["class" => "input", "placeholder" => $model->getAttributeLabel('expire')])->label(false) ?>
